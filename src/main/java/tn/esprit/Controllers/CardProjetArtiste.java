...
public class CardProjetArtiste {
    ...
    void afficherProjetById(MouseEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/AfficherUnProjetParIdArtiste.fxml"));
            Parent root = loader.load();
            AfficherUnProjetParIdArtiste controller = loader.getController();
