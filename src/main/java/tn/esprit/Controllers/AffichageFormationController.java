...
import tn.esprit.Controllers.UpdateController;
import tn.esprit.Models.Formation;
...
public class AffichageFormationController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ImageView imageView4 = new ImageView(getClass().getResource("/images/pdf.png").toExternalForm());
        id_pdf.setGraphic(imageView4);
        ImageView imageView3 = new ImageView(getClass().getResource("/images/remouve.png").toExternalForm());
        id_clear.setGraphic(imageView3);
        ImageView imageView2 = new ImageView(getClass().getResource("/images/update.png").toExternalForm());
        id_update.setGraphic(imageView2);
        ImageView imageView1 = new ImageView(getClass().getResource("/images/del.png").toExternalForm());
        id_del.setGraphic(imageView1);
        ImageView imageView5 = new ImageView(getClass().getResource("/images/add.png").toExternalForm());
    ...
    private void ajouterFormation(ActionEvent event) throws IOException {
        Parent page1 = FXMLLoader.load(this.getClass().getResource("/AjoutFormation.fxml"));
...
private void UpdateFormation(ActionEvent event) throws IOException {
    ...
    private void pdf(ActionEvent event) {
        ...
        Pdf pd=new Pdf();
        try{
        pd.GeneratePdf("La liste de toutes les formations ");
   ...
   id_liste.setItems(FXCollections.observableArrayList(filteredList));
    ...
    private void inscrire(ActionEvent event) throws IOException {
                ...
                if ( id !=0)
                {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/Inscription1.fxml"));
                Parent root = loader.load();
