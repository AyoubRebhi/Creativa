...
public class AjoutFormationController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
       ImageView imageView2 = new ImageView(getClass().getResource("/images/add.png").toExternalForm());

        id_add_f.setGraphic(imageView2);
         ImageView imageView1 = new ImageView(getClass().getResource("/images/telecharge.png").toExternalForm());
