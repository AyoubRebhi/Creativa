...
public class UpdateController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        // TODO
          ...
          ImageView imageView = new ImageView(getClass().getResource("/tn/esprit/maytest/images/telecharge.png").toExternalForm());
...
private void copyImageToServer(File selectedFile) throws IOException {
   ...
   public void initData(int data) {
    ...
    private void abodonner(ActionEvent event) throws IOException {
        Parent page8 = FXMLLoader.load(getClass().getResource("/tn/esprit/maytest/AffichageFormation.fxml"));
